...
export function MenuButton({ item, active, compact = false, variant = 'default', onClick }) {
  ...
  return (
    <button
      className={`group relative grid w-full cursor-pointer items-center gap-3 rounded-[13px] border-4 border-white/95 bg-gradient-to-b from-[#ffc47d] to-[#ff9b2f] px-4 py-4 text-left font-black text-white shadow-[0_7px_0_rgba(95,60,31,0.22),0_16px_28px_rgba(78,45,21,0.16)] transition duration-200 hover:-translate-y-1 hover:saturate-110 hover:shadow-[0_12px_0_rgba(95,60,31,0.18),0_20px_30px_rgba(78,45,21,0.2)] focus-visible:-translate-y-1 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-orange-200 active:translate-y-[4px] active:shadow-[0_2px_0_rgba(95,60,31,0.22),0_4px_12px_rgba(78,45,21,0.1)] ${compact ? 'aspect-[3/1] grid-cols-[28px_1fr_22px]' : 'aspect-[2.5/1] grid-cols-[32px_1fr] sm:px-6'} ${active ? 'from-[#e26e21] to-[#97411d]' : ''}`}
      type="button"
      onClick={handleClick}
    >
